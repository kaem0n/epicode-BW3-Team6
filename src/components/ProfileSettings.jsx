                ...
                <Row>
                  <Col xs={12} lg={6}>
                    <Row>
                      ...
                      <Col xs={11} sm={10}>
                        Aggiungi più di una lingua al tuo profilo, cosi sarà più
                        facile trovarti.
                      </Col>
                    </Row>
                  </Col>
                  <Col xs={12} lg={6}>
                    <Row>
                      ...
                      <Col xs={11} sm={10}>
                        Se disponibile, mostreremo il tuo profilo nella lingua
                        di chi lo visita. Se non c'è corrispondenza, verrà
                        mostrato il tuo profilo predefinito
                      </Col>
                    </Row>
                  </Col>
                </Row>
